...
if (get('documento') !=''){ MantDocumento(get('documento'));}
...
global $ConexionEmpresa, $enlace;
    switch ($Arg) {
        case "documento":
            ...
            $sql = 'SELECT Codigo, cdg_tdoc, num_docu, fecha, razon_soc, ruc_cli , Codigo AS CodigoAjax  FROM m_doccli ';
            $clase = 'reporteA';
            $enlaceCod = 'CodigoPD';
        ...
        case "Crear":
            ...
            $uRLForm = "Guardar]".$enlace."?metodo=control_docu&transaccion=INSERT]PanelA1]F]}";
            $form = c_form_ult('',$ConexionEmpresa,'control_docu', 'CuadroA', $path, $uRLForm, $codEnt, $tSelectD);
        ...
        case "Editar":
            ...
            $uRLForm = "Actualizar]".$enlace."?metodo=control_docu&transaccion=UPDATE&CodigoPD=".$CodigoPD."]PanelA1]F]}";
            $form = c_form_ult('',$ConexionEmpresa,'control_docu', 'CuadroA', $path, $uRLForm, $CodigoPD, $tSelectD);
            $form = "<div style='width:240px;'>".$form."</div>";
