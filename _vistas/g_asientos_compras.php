...
$enlace = "./_vistas/g_asientos_compras.php";
...
if (get("metodo") != ""){
    ...
    if(get("TipoDato") == "texto"){
        ...
        if(get("transaccion") == "UPDATE"){
            if(get("metodo") == "Asiento_Cab"){p_gf_ult("Asiento_Cab",get('codAsi'),$ConexionEmpresa);Asiento("Listado",'',0);# UptAsientodet(get('codAsi'));
            }
    ...
    switch ($Arg) {
        ...
        case "CrearDet":
            ...
            $tSelectD = array(
                ...
                'LibroContable' => 'SELECT Codigo,Descripcion FROM ct_libros_contables WHERE Codigo=1',
    ...
    switch ($arg) {
        case 'Crear':
            ...
            $tSelectD = array(
                ...
                'Tipo_Libro' => 'SELECT Codigo,Descripcion FROM ct_libros_contables WHERE Codigo=1',
